...
exports.getAllPaymentAccounts = exports.addPaymentAccount = void 0;
const paymentAccountsService = __importStar(require("../services/payments/payment-accounts.service"));
...
const addPaymentAccount = async (req, res) => {
    ...
    const createPaymentAccountModel = req.body;
...
exports.getAllPaymentAccounts = getAllPaymentAccounts;
