...
export class ClientsRepository {
  async createClient(data: CreateClientModel): Promise<Result<ClientModel>> {
    try {
  ...
  async fetchClientsPaginated({ page, pageSize }: PaginatedPayload): Promise<Result<PaginatedResultData<ClientModel>>> {
  ...
  async fetchRecentClients(limit: number): Promise<Result<PaginatedResultData<ClientModel>>> {
    try {
