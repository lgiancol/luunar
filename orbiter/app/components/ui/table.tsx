...
function TableHead({ className, ...props }: React.ComponentProps<'th'>) {
  return (
    <th
      ...
      className={cn(
        'h-10 bg-primary-800 px-2 text-left align-middle font-medium whitespace-nowrap text-text-primary-50 [&:first-child]:pl-4 [&:has([role=checkbox])]:pr-0 [&:last-child]:pr-4 [&>[role=checkbox]]:translate-y-[2px]',
        className
      )}
      {...props}
    />
